...
public class TankGameImages {
	 ...
	 * 游戏开始图像
	 */
	public static Image startImage	=Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/images/gameStart.png"));
	/**
	 * 子弹图像
	 */
	 ...
	 * 游戏失败时图像
	 */
	public static Image gameOver	=Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/images/gameOver.gif"));
	/**
	 * 胜利时的图像
	 */
	public static Image gameWin		=Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/images/gameWin.gif"));
	/**
	 * 洋葱头 笑
	 */
	public static Image yct_smile1		=Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/images/yct1.png"));
	public static Image yct_smile2		=Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/images/yct2.png"));
	public static Image font			=Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/images/font.png"));
}
